...
const fetchData = async (endpoint, stateRef) => {
  try {
    ...
    const response = await fetch(
      `https://api.swancapital.in/${endpoint}`,
      {
        method: "GET",
        headers: {
...
const fetchNewDict = async () => {
  try {
    ...
    const response = await fetch("https://api.swancapital.in/fetchClientMultiplier", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
const updateMultiplier = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `https://api.swancapital.in/UpdateClientMultiplier`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
