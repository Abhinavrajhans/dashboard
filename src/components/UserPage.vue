...
const connectStrategyWebSocket = () => {
  const clientStrategySocket = new WebSocket('wss://api.swancapital.inchart/strategy');
...
const connectBasketWebSocket = () => {
  const clientBasketSocket = new WebSocket('wss://api.swancapital.inchart/basket');
...
const connectClientDetailsWebSocket = () => {
  const clientDetailSocket = new WebSocket('wss://api.swancapital.inclientdetails');
